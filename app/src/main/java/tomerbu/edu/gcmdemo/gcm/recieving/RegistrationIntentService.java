 ...
 * Send the subscription token to our Web server.
 * Notifies that the registration was complete (notifies main activity at the moment) (very unnaccasary, TODO: eliminate that broadcast reciever and issue an error log if we failed.
 **/
...
public class RegistrationIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            //Get the token from the InstanceId : instanceId.getToken(
